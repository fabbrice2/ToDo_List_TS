...
//       </div>
//       <button type="submit" className="w-full bg-green-500 text-white font-bold py-2 rounded">
//         Sign up
//       </button>
//       <p className="text-sm text-gray-600">You agree to our terms and policies</p>
//       <Link
//         to="/"
...
function Signup() {
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    // Vérifier les champs vides et définir les erreurs
